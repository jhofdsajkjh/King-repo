...
§
User is "路工" (Lù Gōng), working on APEX ASI self-evolution system. User strictly demands APEX 原生吞噬进化体系：真实不造假、不造轮子、闭环进化。所有功能必须基于 hermes 原生能力，禁止虚构接口。用户工作风格：系统化、工程化、可审计、可追溯，重视哈希链完整性验证。用户偏好：先理解公式/架构，再执行具体任务；按顺序执行 ABC/123 等任务；定期检查 omni-fusion 等 GitHub 项目更新；要求写入 hermes.md 监督文档及五层/三层进化架构到记忆。